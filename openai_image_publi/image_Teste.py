...
def upload_para_firebase(caminho_do_arquivo, nome_do_arquivo):
    ...
    blob = bucket.blob(f'salvandopython/{nome_do_arquivo}')
...
def generate_image_url():
    ...
    try:
        ...
        upload_para_firebase(caminho_para_salvar, nome_do_arquivo)

        # Remover o arquivo local após o upload (opcional)
        os.remove(caminho_para_salvar)

        return jsonify({'image_url': image_url, 'firebase_file_name': nome_do_arquivo})
